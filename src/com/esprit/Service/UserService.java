...
public class UserService {
      ...
      public void login(String username, String password) {
        ...
        String url = "http://localhost/pi-gestion_employes/web/app_dev.php/mobile/login?username=" + username + "&password=" + password;
        con.setUrl(url);
        con.addResponseListener((evt) -> {
            ...
            if (!response.trim().contains("NOPE")) {
                ...
                Dialog.show("Conf", "Mot de passe de connexion invalide", "ok", null);
       ...
       public void Register(String username, String email, String password) {
        ...
        String url = "http://localhost/pi-gestion_employes/web/app_dev.php/mobile/Register?username=" + username + "&email=" + email + "&password=" + password;
        con.setUrl(url);
        NetworkManager.getInstance().addToQueueAndWait(con);
